(ns bookexamples.forclojure.infinite-matrix-test
  (:require [clojure.test :refer :all]
            [bookexamples.forclojure.infinite-matrix :refer :all]))

(deftest infinite-matrix-test
  (testing "Tests the infinite matrix problem from 4Clojure"
